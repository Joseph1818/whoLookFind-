...
export default function Result2Artc() {
                  ...
                  <Row>
                    ...
                    <Col sm={9}>
                      <div className="content-section">
                        <h3 className="subject"> Articles's Subjects</h3>
                          ...
                          {list.subjects.map((lists, i) => {
                            return (
                              <div className="subjects-list">
                                {
                                  <ul>
                                    <li className="subject">{lists.name}</li>
                                  </ul>
                                }
                              </div>
                            );
                        ...
                        <div class="article-component-section">
                          <div className="">
                            ...
                            <p>
                              ...
                              adipisicing elit. Assumenda quibusdam nam, laborum
                              veritatis est tempore? Obcaecati corporis fugiat
                              deserunt. Aut asperiores unde consequatur, cumque
                              ratione delectus itaque, consectetur perspiciatis
                              blanditiis a, culpa assumenda quod fugiat
                              obcaecati aliquam reiciendis aspernatur eveniet
                              omnis amet? Praesentium quaerat, soluta nisi
                              maiores quasi eveniet quod repellendus hic sint ut
                              cum deserunt laborum dignissimos quibusdam
